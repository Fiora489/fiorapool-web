...
import type { LayoutKey } from './LayoutPicker'

export function CardPreview({ layout, cacheKey }: { layout: LayoutKey; cacheKey: number }) {
  const src = `/api/share/card?layout=${layout}&t=${cacheKey}`
